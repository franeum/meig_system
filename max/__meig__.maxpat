...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 1665.0, 240.0, 58.0, 22.0 ],
					"text" : "r openfile"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 3021.411473717008448, 840.0, 73.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 2910.0, 840.0, 85.0, 22.0 ],
					"text" : "print parse-roll"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 930.0, 660.0, 35.0, 22.0 ],
					"text" : "open"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 930.0, 690.0, 51.0, 22.0 ],
					"text" : "pcontrol"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 823.5, 278.0, 77.0, 22.0 ],
					"text" : "prepend turn"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "int" ],
					"patching_rect" : [ 823.5, 248.0, 29.5, 22.0 ],
					"text" : "+ 1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 780.0, 210.0, 56.0, 22.0 ],
					"text" : "route 0 3"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int", "", "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 780.0, 30.0, 135.0, 105.0 ],
					"presentation" : 1,
...
,
					"patching_rect" : [ 930.0, 720.0, 51.0, 22.0 ],
					"saved_object_attributes" : 					{
						"description" : "",
						"digest" : "",
						"globalpatchername" : "",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 555.0, 809.0, 466.0, 22.0 ],
					"text" : "http://127.0.0.1:3000/api/v1/params/tree?id=6187d0f69360cfd33c31984a&label=event"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 1695.0, 120.0, 24.0, 24.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 615.0, 720.0, 61.0, 22.0 ],
					"text" : "get_event"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 1680.0, 180.0, 108.0, 22.0 ],
...
,
					"patching_rect" : [ 1590.0, 180.0, 87.0, 22.0 ],
					"saved_object_attributes" : 					{
						"description" : "",
						"digest" : "",
						"globalpatchername" : "",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 45.0, 1155.0, 705.0, 22.0 ],
					"text" : "0 bang"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 1830.0, 270.0, 108.0, 22.0 ],
					"text" : "clear, numvoices 2"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 1920.0, 120.0, 87.0, 22.0 ],
					"text" : "print ctroROLL"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 3090.0, 675.0, 100.0, 22.0 ],
					"saved_object_attributes" : 					{
						"versionnumber" : 80100
					}
,
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 645.0, 225.0, 51.0, 22.0 ],
					"text" : "print roll"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 3026.207842673574305, 1125.0, 60.0, 22.0 ],
					"text" : "s openfile"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 2910.0, 615.0, 66.0, 22.0 ],
					"text" : "r parse-roll"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 1590.0, 105.0, 52.0, 22.0 ],
					"text" : "r ctrl-roll"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 1530.0, 210.0, 35.0, 22.0 ],
					"text" : "clear"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 3026.207842673574305, 1084.427875578403473, 19.0, 22.0 ],
					"text" : "t l"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 2910.0, 660.0, 24.0, 24.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 3210.0, 750.0, 430.66667652130127, 326.666673421859741 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "dictionary" ],
					"patching_rect" : [ 3021.411473717008448, 630.0, 74.0, 22.0 ],
					"saved_object_attributes" : 					{
						"versionnumber" : 80100
					}
,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 4,
					"outlettype" : [ "dictionary", "", "", "" ],
					"patching_rect" : [ 3021.411473717008448, 720.0, 73.0, 22.0 ],
					"saved_object_attributes" : 					{
						"embed" : 0,
						"parameter_enable" : 0,
						"parameter_mappable" : 0
...
,
					"patching_rect" : [ 1421.0, 105.0, 52.0, 22.0 ],
					"saved_object_attributes" : 					{
						"description" : "",
						"digest" : "",
						"globalpatchername" : "",
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 1365.0, 195.0, 108.0, 22.0 ],
					"saved_object_attributes" : 					{
						"versionnumber" : 80100
					}
,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 1515.0, 180.0, 39.0, 22.0 ],
					"text" : "dump"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 1500.0, 1035.0, 87.0, 22.0 ],
					"text" : "s rollout_dump"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 1500.0, 150.0, 41.0, 22.0 ],
					"text" : "r rollin"
				}
...
, 			{
				"box" : 				{
					...
					"out" : "nnnnnnn",
					"outlettype" : [ "", "", "", "", "", "", "", "bang" ],
					"patching_rect" : [ 1500.0, 315.0, 1355.0, 694.532447576522827 ],
					"pitcheditrange" : [ "[", "[", 5600, 8500, "]", "]", "[", "[", 5600, 8500, "]", "]", "[", 6400, "]" ],
					"presentation" : 1,
					"presentation_rect" : [ 570.0, 105.0, 1158.0, 630.284249424934387 ],
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 330.0, 165.0, 24.0, 24.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 365.468902786572471, 165.0, 123.333332538604736, 20.0 ],
...
,
					"patching_rect" : [ 360.0, 225.0, 106.0, 22.0 ],
					"saved_object_attributes" : 					{
						"description" : "",
						"digest" : "",
						"globalpatchername" : "",
...
, 			{
				"box" : 				{
					...
					"text" : "http://127.0.0.1:3000/api/v1/preset/tree?id=6184620e2b9627a5fd179d15&onset=100"
				}
...
, 			{
				"box" : 				{
					...
					"text" : "\"event_params event_params [  6189a2fbd7218ce65912ec58 6189a2f33aba77e3abe9a4c6 ] [group/c/param_1 group/a/param_1 ]\""
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 360.0, 345.0, 61.0, 22.0 ],
					"text" : "s tobridge"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 195.0, 675.0, 101.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 270.0, 375.0, 61.0, 22.0 ],
					"text" : "hidden $1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 525.0, 348.5, 210.0, 75.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 15.0, 225.0, 525.0, 540.0 ],
					"rendermode" : 0,
					"url" : "http://127.0.0.1:3000/api/v1/preset/tree?id=6189a306fb3f32a67bff6e01&onset=100&label=preset",
					"varname" : "presets-ui"
				}
...
, 			{
				"box" : 				{
					...
					"presentation_rect" : [ 15.0, 225.0, 525.0, 540.0 ],
					"rendermode" : 0,
					"url" : "http://127.0.0.1:3000/api/v1/params/tree?id=6189b030fff80b18f5d0b4e0&label=event",
					"varname" : "params-ui"
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-12", 0 ],
					"midpoints" : [ 789.5, 340.5, 369.5, 340.5 ],
					"source" : [ "obj-10", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 279.5, 429.5, 69.5, 429.5 ],
					"source" : [ "obj-11", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-19", 0 ],
					"midpoints" : [ 624.5, 752.0, 564.5, 752.0, 564.5, 709.0, 504.5, 709.0 ],
					"source" : [ "obj-74", 0 ]
				}
